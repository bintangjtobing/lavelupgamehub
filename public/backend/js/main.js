...
var storedHtmlMarkup = {
    top_up_game_recharge_credentials_field: `<div class="row align-items-end justify-content-end">
    <div class="col-xl-4 col-lg-4 form-group">
        <label>Recharge Amount*</label>
        <div class='d-flex'>
            <input type="number" class="form--control" placeholder="Type Here..." name="credit_amount[]">
    ...
    <div class="col-xl-4 col-lg-4 form-group">
        <label>Price*</label>
        <div class="d-flex">
            <input type="number" class="form--control" placeholder="Type Here..." name="currency_amount[]">
    ...
    top_up_game_player_id_credentials_field: `<div class="row align-items-end">
    <div class="col-xl-6 col-lg-6 form-group">
        <label>Label*</label>
        <input type="text" class="form--control" placeholder="Type Here..." name="label[]">
    </div>
